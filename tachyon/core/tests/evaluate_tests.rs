...
macro_rules! test_eval_binary_fn {
    (
        ...
        fn $test_name() {
            ...
            let col_a = random_column!(a_vec, "a", $data_type);
            let col_b = random_column!(b_vec, "b", $data_type);
...
test_eval_binary_matrix!(
    ...
    [
        ...
        /*(test_add_f32_small, f32, DataType::F32, f64, 1024),
        (test_add_f32_medium, f32, DataType::F32, f64, 1024 * 10),
        (test_add_f32_large, f32, DataType::F32, f64, 1024 * 100),
